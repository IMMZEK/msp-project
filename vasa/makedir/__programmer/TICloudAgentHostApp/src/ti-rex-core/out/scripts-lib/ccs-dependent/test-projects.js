 ...
 */
exports.testProjects = function (args, callback) {
    util.testProjects(args, callback);
};
///////////////////////////////////////////////////////////////////////////////
...
exports.describe =
    'Test all the projects in tirex in a desktop environment, verifying they import and build successfully. Deletes all projects from the workspace then runs an import & build on each project, deleting all projects from the workspace in between each import & build.';
exports.builder = {
    tirexUrl: {
        alias: 't',
...
exports.handler = function (argv) {
    exports.testProjects(argv, (err, { total, failed, error, skipped, log } = {}) => {
        if (err) {
            console.log(err);
            process.exit(1);
        }
