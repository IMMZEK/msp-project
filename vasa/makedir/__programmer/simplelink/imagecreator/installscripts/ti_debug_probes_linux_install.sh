...
if [ "${OPT}" == "-h" -o "${OPT}" == "--help" ]; then
	echo "This program installs the Texas Instruments Debug Probes udev rules file"
	echo "Usage: ti_debug_probes_linux_install.sh [options]"
	echo "Options:"
...
# All done
echo "Rules file installation completed successfully.  Some versions of Linux"
